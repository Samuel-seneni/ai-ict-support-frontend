...
const About = () => {
  return (
    <div className="w-full overflow-hidden bg-white">
      ...
      {/* ================= HERO ================= */}
      <section className="relative pt-28 pb-20 md:pt-32 md:pb-24 bg-gradient-to-br from-sky-50 via-white to-blue-50">

        <div className="absolute top-[-120px] left-[-120px] w-[400px] h-[400px] bg-blue-200 blur-3xl opacity-40 rounded-full" />
        <div className="absolute bottom-[-120px] right-[-120px] w-[400px] h-[400px] bg-cyan-200 blur-3xl opacity-40 rounded-full" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            About <span className="text-blue-600">Smart ICT Desk</span>
          </motion.h1>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="mt-5 text-base sm:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed"
          >
      ...
      <section className="py-20 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <FaSchool className="text-4xl mb-5" />
